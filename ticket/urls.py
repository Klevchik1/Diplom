...
urlpatterns = [
    ...
    path('manager/api/movies/filter/', views.api_movies_filter, name='api_movies_filter'),
    path('manager/api/movie/<int:movie_id>/can-delete/', views.api_movie_can_delete, name='api_movie_can_delete'),
    path('manager/api/screenings/filter/', views.api_screenings_filter, name='api_screenings_filter'),
    path('manager/api/statistics/filter/', views.api_statistics_filter, name='api_statistics_filter'),
    ...
    path('admin-panel/', include([
        ...
        path('roles/add/', views_admin.admin_role_add, name='admin_panel_role_add'),
        path('roles/<int:group_id>/delete/', views_admin.admin_role_delete, name='admin_panel_role_delete'),
        ...
        path('ticket-groups/<int:group_id>/delete/', views_admin.admin_ticket_group_delete, name='admin_panel_ticket_group_delete'),
