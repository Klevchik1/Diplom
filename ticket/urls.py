...
urlpatterns = [
    ...
    path('admin-panel/', include([
        ...
        path('pending-registrations/', views_admin.admin_pending_registrations, name='admin_panel_pending_registrations'),
        path('pending-registrations/<int:pr_id>/delete/', views_admin.admin_pending_registration_delete, name='admin_panel_pending_registration_delete'),
